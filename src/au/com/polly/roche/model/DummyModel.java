...
public synchronized void initialise()
{
    ...
    venusLocation = new Point( -ModelConstants.AU * 0.8, 0.0 );
    sunVelocity = new Vector( 0.0, 0.0 );
    earthVelocity = new Vector( 0.0, 29790 );
    venusVelocity = new Vector( 0.0, 25000 );
...
{
    Object result = new DummyModel();
    DummyModel dummy = (DummyModel)result;
